...
(set-face-attribute 'default nil :font "Fira Code" :height 170 :background "black")
...
(defun efs/org-font-setup ()
  ...
  (set-face-attribute 'org-table nil   :inherit '(shadow fixed-pitch) :foreground "#fff383")
...
(defun efs/org-mode-keys ()
 ...
 ;;(define-key org-mode-map (kbd "C-i") #'my-indent-org-block-automatically)
